...
function render(){
  ...
  document.querySelectorAll(".location-tab").forEach(b=>{const on=b.dataset.location===activeLocation;b.classList.toggle("active",on);b.setAttribute("aria-selected",on)});
